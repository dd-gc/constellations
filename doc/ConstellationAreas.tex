...
In order to utilize this, a vector field $\bvec{A}$ needs to be found such that $\nabla \times \bvec{A}$ has a constant radial
component on the surface of the unit sphere.  Then, the line integral in (\ref{eq:stokes}) along the closed constellation
boundaries will yield the surface area within.

In spherical coordinates, the radial component of the curl is expressed as (\ref{eq:radialcurl}),
...
meridian.  This makes it tricky to properly account for constellations that cross over that line.
...
\bibitem{brink}
M. Ebada, A. Elkelesh, S. Cammerer and S. ten Brink, "Scattered EXIT Charts for Finite Length LDPC Code Design," 2018 IEEE International Conference on Communications (ICC), Kansas City, MO, USA, 2018, pp. 1-7, doi: 10.1109/ICC.2018.8422961.

\bibitem{benedetto}
Benedetto, Sergio, and Ezio Biglieri. Principles of Digital Transmission: With Wireless Applications. Kluwer Academic/Plenum Press, 1999.

\bibitem{chugg}
Chugg, Keith M., et al. Iterative Detection: Adaptivity, Complexity Reduction, and Applications. Kluwer Academic Publishers, 2001.
\end{thebibliography}
